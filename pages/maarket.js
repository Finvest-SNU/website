...
const FrameComponent = () => {
  return (
    <div className={styles.parent}>
      ...
      <div className={styles.theMarket}>THE MARKET</div>
      <div className={styles.ourBlog}>OUR BLOG</div>
      
      <img className={styles.icon4} alt="" src="../1@2x.png" />
      <img className={styles.icon5} alt="" src="../2@2x.png" />
      <img className={styles.icon6} alt="" src="../66.png" />
      ...
      <div className={styles.Content2}>
        What is happening around the world 2 A highly-curated platform for
        creating, collecting and trading unique NFTs. Trade with confidence on
        the world’s fastest and most secure crypto exchange ...
      </div>
      <div className={styles.Namdiv}>By Mrityunjay Prasad </div>
      <div className={styles.europeanUnionIn}>
        European Union in crisis while Russia watches
      </div>
      <div className={styles.Namdiv1}>By Mrityunjay Prasad 1</div>
      ...
      <div className={styles.Heading3}>
        What is happening around the world 3
      </div>
      <div className={styles.Content4}>
        What is happening around the world 4 A highly-curated platform for
        creating, collecting and trading unique NFTs. Trade with confidence on
      ...
      <div className={styles.Heading5}>
        What is happening around the world 5
      </div>
      <div className={styles.Content6}>
        What is happening around the world 6 A highly-curated platform for
        creating, collecting and trading unique NFTs. Trade with confidence on
        the world’s fastest and most secure crypto exchange ...
      </div>
